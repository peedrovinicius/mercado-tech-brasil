...
O projeto analisa movimentações do emprego formal captadas pelas fontes utilizadas. As métricas publicadas preservam esse recorte em seus metadados e na interface.
